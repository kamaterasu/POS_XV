...
export default function DraftManagerDialog({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-5xl bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden max-h-[90vh] flex flex-col animate-in slide-in-from-bottom duration-400 ease-out"
